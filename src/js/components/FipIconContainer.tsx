...
class FipIconContainer extends React.PureComponent<
  IFipIconContainerProps,
  FipIconContainerState
> {
  static defaultProps = {
    categories: null,
    ...
    return (
      <div className="rfipicons__pager">
        <div className="rfipicons__num">
          ...
          <span className="rfipicons__tp">{this.state.totalPage}</span>
        </div>
  ...
  render() {
    return (
      <div className="rfipicons">
        {this.renderPager()}
        <div className="rfipicons__selector">{this.renderIconView()}</div>
      </div>
    );
  }
}
