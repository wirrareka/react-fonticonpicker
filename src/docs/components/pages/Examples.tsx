...
class Examples extends React.PureComponent<{}, ExamplesState> {
  state = {
    value1: 57436,
    value2: [],
    value3: 57595,
        ...
        <ul className="list-group">
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
              <h5 className="mb-1">Append to Body & Single Picker</h5>
              <small>
                <code>isMulti={"{false}"} appendTo=&quot;body&quot;</code>
              </small>
            </div>
            <p className="mb-1">
              The picker element uses <code>appendTo=&quot;body&quot;</code> to
              append the protal to body. This uses{" "}
              <code>React.createPortal</code> to append the dropdown to another
              element.
            </p>
            <FontIconPicker
            ...
            <p>
              <small>
                ...
                <span className="badge badge-light">
                  <i data-icomoon={String.fromCodePoint(this.state.value1)} />
                </span>
              </small>
            </p>
          </li>
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
              <h5 className="mb-1">Append to Body & Multi Picker</h5>
              <small className="text-muted">
                <code>isMulti={"{true}"} appendTo=&quot;body&quot;</code>
              </small>
            </div>
            <p className="mb-1">
              The component uses <code>isMulti</code> (default) to pick multiple
              values.
            </p>
            <FontIconPicker
              icons={iconDefs.icomoonIcons}
            ...
            <p>
              <small className="text-muted">
                ...
                {this.state.value2.map(value => (
                  <span className="badge badge-light" key={value}>
                    <i data-icomoon={String.fromCodePoint(value)} />
                  </span>
                ))}
              </small>
            </p>
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
              <h5 className="mb-1">Append to Self & Single Picker</h5>
              <small className="text-muted">
                <code>isMulti={"{false}"} appendTo=&quot;self&quot;</code>
              </small>
            </div>
            <p className="mb-1">
              The element uses{" "}
              <code>appendTo=&quot;self&quot; isMulti={"{false}"}</code> to
              append to the current div instead of somewhere else.
            </p>
            <FontIconPicker
              icons={iconDefs.icomoonIcons}
              search={iconDefs.icomoonIconsSearch}
            ...
            <p>
              <small className="text-muted">
                Current value:{" "}
                <span className="badge badge-light">
                  <i data-icomoon={String.fromCodePoint(this.state.value3)} />
                </span>
              </small>
            </p>
          </li>
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
              <h5 className="mb-1">Append to Self & Multi Picker</h5>
              <small className="text-muted">
                <code>isMulti={"{true}"} appendTo=&quot;self&quot;</code>
              </small>
            </div>
            <p className="mb-1">
              The element uses{" "}
              <code>appendTo=&quot;self&quot; isMulti={"{true}"}</code> to pick
              multiple icons.
            </p>
            <FontIconPicker
              icons={iconDefs.icomoonIcons}
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              When <code>search</code> is null, the value of <code>icons</code>{" "}
              are used.
            </p>
            <FontIconPicker
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              A custom renderer function is used to render SVG. The function
              takes the value as argument, and should return a react element or
              JSX.
            </p>
            <FontIconPicker
              icons={iconDefs.svgs}
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              When <code>showCategory={"{false}"}</code>, even categorized
              source is flattened.
            </p>
            <FontIconPicker
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              With <code>showSearch={"{false}"}</code> the search input is not
              displayed.
            </p>
            <FontIconPicker
              icons={iconDefs.fontAwesome}
          ...
          <li className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              With <code>closeOnSelect={"{true}"}</code> the modal is closed on
              icon select.
            </p>
            <FontIconPicker
              icons={iconDefs.fontAwesome}
